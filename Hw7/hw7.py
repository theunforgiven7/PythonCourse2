...
def process_datesearch_text(your_file):
    ...
    Args:
        your_file (str): файл з текстом(літери)

    Returns:
        str: Результати аналізу тексту, кількість голосних та приголосних літер, 
             3 найпопулярніших голосні літери(Якщо голосних літер більше) або найпопулярнішу приголосну(Якщо приголосних літер більше) літеру або повідомлення 
             про однакову кількість голосних та приголосних літер.
    """
